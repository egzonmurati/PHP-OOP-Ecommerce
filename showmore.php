                            ...
                            <div class="col-md-8">
                                <div class="card-body">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item text-uppercase"><i class="fas fa-mobile-alt fa-lg"></i> Display: <span class="fw-bolder ps-2"><?php echo $row['display'] ?></span></li>
                                        <li class="list-group-item text-uppercase"><i class="fas fa-battery-three-quarters fa-lg"></i> Battery: <span class="fw-bolder ps-2"><?php echo $row['battery'] ?></span></li>
                                        <li class="list-group-item text-uppercase"><i class="fas  fa-database fa-lg"></i> RAM: <span class="fw-bolder ps-2"><?php echo $row['hardware'] ?></span></li>
                                        <li class="list-group-item text-uppercase"><i class="fas fa-camera fa-lg"></i> Camera: <span class="fw-bolder ps-2"><?php echo $row['camera'] ?></span></li>
